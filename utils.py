...
# Load the TSV file into a DataFrame using a different encoding
reviews_submit_df = pd.read_csv('reviews_submit.tsv', delimiter='\t', encoding='latin1')

# Display the first few rows of the DataFrame to verify
reviews_submit_df.head()
